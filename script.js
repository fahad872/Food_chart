...
function getAllVegetableData(){
    ...
    const vegetables = foodData.filter(
...
function getAllFruitData(){
  ...
  const fruits = foodData.filter((item) => item.category === "Fruit");
  console.log(fruits); 
}
getAllFruitData();
...
function getAllProtienData(){
  ...
  const protiensData = foodData.filter((item) => item.category ==="Protein");
...
function getAllNutsData(){
  ...
  const nuts = foodData.filter((item) => item.category === "Nuts");
  console.log(nuts);
}
getAllNutsData();
...
function getAllGrainsData(){
  ...
  const grains = foodData.filter((item) => item.category === "Grain");
  console.log(grains);
}
getAllGrainsData();
...
function getAllDairyData(){
  ...
  const dairy = foodData.filter((item) => item.category ==="Dairy");
  console.log(dairy);
}
getAllDairyData();
